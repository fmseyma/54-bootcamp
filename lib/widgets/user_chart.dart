    ...
    return Padding(
      ...
      child: Container(
        ...
        child: Stack(
          ...
          children:[
  PhotoChart(),
  Text(appuser.ad+" " +appuser.soyad , style:GoogleFonts.oswald(fontWeight: FontWeight.bold),),
  Padding(
    padding: const EdgeInsets.all(8.0),
    child: Text(appuser.bio , style:GoogleFonts.oswald(fontWeight: FontWeight.w100),),
  )
